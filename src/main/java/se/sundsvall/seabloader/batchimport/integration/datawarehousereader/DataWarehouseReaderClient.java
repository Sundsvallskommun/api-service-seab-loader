...
import static se.sundsvall.seabloader.batchimport.integration.datawarehousereader.configuration.DataWarehouseReaderConfiguration.CLIENT;
...
@FeignClient(name = CLIENT, url = "${integration.datawarehousereader.url}", configuration = DataWarehouseReaderConfiguration.class)
